...
#define MASTER_VERSION "V3.05a-candidate"		// now no suffix indicates default .tdb is kingbase
#else
#define MASTER_VERSION "V3.05a-candidate-g"   // 'g' indicates default .tdb is great players database
#endif
