...
#define MASTER_VERSION "V3 Post Beta 2016-08-13-a(k)"  // 'k' indicates default .tdb is kingbase
#else
#define MASTER_VERSION "V3 Post Beta 2016-08-13-a(g)"  // 'g' indicates default .tdb is great players database
#endif
