...
#define MASTER_VERSION "V3.00b"		// now no suffix indicates default .tdb is kingbase
#else
#define MASTER_VERSION "V3.00b-g"   // 'g' indicates default .tdb is great players database
#endif
