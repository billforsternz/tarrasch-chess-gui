...
#define MASTER_VERSION_BASE "V3.20a-"    //add '-' or '+' prefix between releases
...
#define DEFAULT_ENGINE "stockfish-windows-x86-64-sse41-popcnt.exe"
#define DEFAULT_ENGINE_64 "stockfish-windows-x86-64-sse41-popcnt.exe"
