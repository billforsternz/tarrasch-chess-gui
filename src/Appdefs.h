...
#define MASTER_VERSION "V3.03a-Linux"	// now no suffix indicates default .tdb is kingbase
#else
#define MASTER_VERSION "V3.03a-g-Linux"   // 'g' indicates default .tdb is great players database
#endif
