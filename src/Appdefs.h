...
#define MASTER_VERSION "V3.00a-xx"		// now no suffix indicates default .tdb is kingbase
#else
#define MASTER_VERSION "V3.00a-g"   // 'g' indicates default .tdb is great players database
#endif
