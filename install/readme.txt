...
4) Once successful, rename the new setup.exe appropriately, eg to setup-tarrasch-v2.03b.exe.
5) Make sure file install.zip doesn't exist in this directory.
6) Select TarraschDb.exe, TarraschDb.ini (empty file), the .tdb file you want to include, book.pgn, and the
Web and Engines subdirectory
Right click and choose 7zip "Add to install.zip".
7) Rename install.zip appropriately, eg to portable-tarrasch-v2.03b.zip.
